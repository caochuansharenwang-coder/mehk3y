...
M  ip.html     crypto.html     btc.html  eth.html        (skip-link + <main>)
...
- Sub-page business logic (`btc.html`, `eth.html`, `crypto.html`, `ip.html`, `apple.html`, `esim.html`, `hermes.html`, `perler.html`) — already well-architected, no functional changes.

const DEFAULT_PASSWORD_HASH = 'f878b3385bdfbc5c2f8e1725706d4c636dd21f906237496aec39860e64a1d90d';
...
function passwordHash() {
  return env('ADMIN_PASSWORD_HASH').trim() || DEFAULT_PASSWORD_HASH;
}

async function hmac(value) {
  const secret = env('ADMIN_SESSION_SECRET') || passwordHash();
